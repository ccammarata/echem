library(foreign)
directory <-list.files("E:/echem_spring_2017/0N5E")
L <- length(directory)
...
cleanedSteps$ABS_AA <- abs(cleanedSteps$AA)
cleanedSteps$selectivity <- abs(cleanedSteps$cholineAvrg*(127.5/20)) / (cleanedSteps$AA)
cleanedSteps$selectivity2 <- (cleanedSteps$cholineAvrg*(127.5/20)) / (cleanedSteps$ABS_AA)
